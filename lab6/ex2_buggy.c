/*
 * Original buggy version. Bug: pointer to data[1] becomes dangling after realloc.
 * Compile: gcc -fsanitize=address -g -o ex2_buggy ex2_buggy.c && ./ex2_buggy
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main() {
    ...
    int* top_score = &scores->data[1];  // BUG: dangling pointer after realloc
